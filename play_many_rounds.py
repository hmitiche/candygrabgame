...
#start = int(start) - 1
print(" agent who starts first picked up randomly!")
...
print(" ag00{0}({1}) vs. ag00{2}({3}) \n for {4} rounds!".\
    format(player1,player2,PLAYER1_PSEUDO,PLAYER2_PSEUDO,num_games))

agents = (bot1, bot2)

for i in range(num_games):
    game = CandyGrab((bot1, bot2), initial_num_pieces)
